...
import { CheckCircle2, ChevronDown, LineChart, ShieldCheck, Zap, Database, FileSpreadsheet, Building2 } from 'lucide-react';
    ...
    const stats = [
        {
            ...
            description: "Controle financeiro, fiscal e de estoque em uma única plataforma robusta.",
            icon: Database
        },
        {
            value: "Zero",
            label: "Erros Fiscais",
            description: "Geração automática de SPED, NF-e, NFC-e e total conformidade com a legislação.",
            icon: ShieldCheck
        },
        {
            value: "Smart",
            label: "Decisões Ágeis",
            description: "Relatórios gerenciais e dashboards em tempo real para o seu negócio.",
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 max-w-2xl">
                        ...
                        >
                            A solução completa para a gestão do seu posto ou varejo. O Lukos ERP centraliza toda a sua operação, desde a compra de combustíveis até o fechamento fiscal, garantindo eficiência e segurança máxima.
                        </motion.p>
                            ...
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <div className="flex-shrink-0 relative">
                                        ...
                                        {/* Decorative check */}
                                        <div className="absolute -top-2 -right-2 w-7 h-7 bg-slate-700 rounded-full border-4 border-[#0a0a0f] flex items-center justify-center">
                    ...
                    <motion.div
                        ...
                        className="flex-1 relative w-full aspect-video max-w-[800px] mx-auto lg:mx-0 rounded-[2.5rem] overflow-hidden border-[6px] border-white/5 shadow-[0_30px_60px_-15px_rgba(139,92,246,0.3),0_15px_30px_-10px_rgba(124,58,237,0.2)]"
                    >
